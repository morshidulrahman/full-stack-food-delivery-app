    ...
    <div className="w-full min-h-screen flex justify-center items-center">
      <div className="w-[90%] md:w-[75%] flex flex-col items-center justify-center gap-4 rounded-lg border border-gray-300 p-4">
                 ...
                 {!assetimage ? (
                  <>
                   ...
                   <div className="h-full relative overflow-hidden">
                      <img src={assetimage} alt="iamges" className="w-full h-full object-cover"/>
                      <button 
                      type="button"
                      onChange={deletphoto}
        ...
        <div className="w-full items-center flex">
            <button 
            onChange={savebutton}
            type="button" className="ml-0 md:ml-auto w-full md:w-auto text-white px-12 py-2 rounded-lg border-none bg-emerald-500 font-semibold">
                 save
            </button>
        </div>
      </div>
